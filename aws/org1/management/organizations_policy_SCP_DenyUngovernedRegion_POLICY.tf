resource "aws_organizations_policy" "SCP_DenyUngovernedRegion_POLICY" {

  name        = "DenyUngovernedRegion"
  description = "Denies most actions in ungoverned regions"
    ...
    "Statement" : [
      {
        "Condition" : {
          "StringNotEquals" : {
            "aws:RequestedRegion" : local.governedRegions
          },
          "ArnNotLike" : {
            "aws:PrincipalARN" : [
